...
import com.ganga.SSMPServiceApplication;
...
@SpringBootTest(classes = SSMPServiceApplication.class)
public class BrandServiceTest {
    ...
    public void TestSaver() {
        ...
        boolean saver = brandService.save(brand);
    ...
    public void TestDeleteById() {
        Integer id = 8;
        boolean b = brandService.removeById(8);
    ...
    public void TestDeleteIds() {
        ...
        */
        ...
        boolean b = brandService.removeBatchByIds(ids);
        System.out.println(b);
    }
